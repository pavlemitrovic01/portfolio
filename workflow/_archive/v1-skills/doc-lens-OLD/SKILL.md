---
name: doc-lens
description: Izvlači samo relevantan deo iz Roadmap-a ili Creative Bible za konkretan task. Koristi cl3-scout (Haiku) za extraction. Sprečava punjenje konteksta celim dokumentima.
---
...
| Parametar | Fajl |
|-----------|------|
| `roadmap` | `workflow/projects/cl3menza/CL3_Planet_Reconstruction_Master_Roadmap.md` |
| `bible` | `workflow/projects/cl3menza/Creative_Bible.md` |

## Proces

### Korak 1 — Spawn cl3-scout

Spawni cl3-scout (Agent tool, `subagent_type: cl3-scout`) sa ovim promptom:
...
Nakon što cl3-scout vrati ekstrakciju:
...
- Nikad ne čitaj ceo dokument sam — uvek delegiraj cl3-scout-u.
- Ako fokus nije dovoljno specifičan → postavi jedno pitanje pre spawna.
- Ako cl3-scout ne pronađe ništa relevantno → vrati "NOT FOUND" i predloži alternativni fokus.
